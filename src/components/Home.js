        ...
        <section class="app-section">
            ...
            <div className="horizontal-flex vertical-margin text-center">
                <div className="width-50 horizontal-padding">
                    <button className="button" onClick={() => window.location.assign('/list')}> All Pokémons </button>
                </div>
                <div className="width-50 horizontal-padding">
                    <button className="button" onClick={() => window.location.assign('/search')}> Search Pokémons </button>
                </div>
            </div>
        </section>
    )
